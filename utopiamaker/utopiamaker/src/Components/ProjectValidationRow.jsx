...
function ProjectValidationRow({projectName, transactions}) {
    ...
    return (
        <>
            ...
            {modal.isShowing && <Modal handleShow={handleShow} isError={modal.isError} isLoading={modal.isLoading} isSuccess={modal.isSuccess} title={"Transactions of "+projectName}>
                ...
                {transactions.map((value, index) => <ValidationRow key={index} id={value}/>)}
            </Modal>}
        </>
    )
}

export default ProjectValidationRow